[?25l
  ...
  >  1. ksorjnzmizzjhdilujty [name: Red Store Timeseries, org: lpzcblpnlrjabbkmszgb, region: ap-south-1]         
    2. stcmaoftrkykszjlivad [name: Red Store DB, org: lpzcblpnlrjabbkmszgb, region: ap-south-1]                  
    3. izlqilvtvjsiglteuhrz [name: Adishrivastava28's Project, org: sdwcttwhpbvusdyixljl, region: ap-southeast-1]
    ...
    ↑/k up • ↓/j down • / filter • q quit • ? more                                                               
                                                                                                                 [0D[2K[?25h[?1002l[?1003l[?1006l[?25l
    Select a project:                                                                                            
  ...
  >  1. ksorjnzmizzjhdilujty [name: Red Store Timeseries, org: lpzcblpnlrjabbkmszgb, region: ap-south-1]         
    ...
    ↑/k up • ↓/j down • / filter • q quit • ? more                                                               
                                                                                                                 [0D[2K[?25h[?1002l[?1003l[?1006lexport type Json =
  | string
  | number
  | boolean
  | null
